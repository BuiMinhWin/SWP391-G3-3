        ...
        <aside className="sidebar col-2 p-3 border-end">
          ...
          <nav>
            <ul className="list-unstyled">
              ...
              <li>
                <a href="#">
                  <i className="bi bi-life-preserver me-2"></i> Help & Support
                </a>
              </li>
              <li>
                <a href="#">
            ...
            <div className="delivery-list col-7">
              ...
              {hoveredOrder && (
                <div className="hovered-order-details mt-3 p-3 bg-light border rounded">
                  <h4>Order Details</h4>
                  <p>
                    <strong>Destination:</strong> {hoveredOrder.destination}
                  </p>
                  <p>
                    <strong>Freight:</strong> {hoveredOrder.freight}
                  </p>
                  <p>
                    <strong>OrderDate:</strong> {hoveredOrder.orderDate}
                  </p>
                  <p>
                    <strong>ShipDate:</strong> {hoveredOrder.shippedDate}
                  </p>
                  <p>
                    <strong>Origin:</strong> {hoveredOrder.origin}
                  </p>
                </div>
              )}
            </div>
            <div className="delivery-map col-5">
              ...
              {selectedDelivery && (
                <div className="delivery-details d-flex justify-content-between mt-2">
                  <p>
                    <strong>Category:</strong> {selectedDelivery.category}
                  </p>
                  <p>
                    <strong>Distance:</strong> {selectedDelivery.distance}
                  </p>
                  <p>
                    <strong>Estimation:</strong> {selectedDelivery.estimation}
                  </p>
                  <p>
                    <strong>Weight:</strong> {selectedDelivery.weight}
                  </p>
                  <p>
                    <strong>Fee:</strong> {selectedDelivery.fee}
                  </p>
                </div>
              )}
            </div>
